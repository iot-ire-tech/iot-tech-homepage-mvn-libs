...
describe("Issing Credit Notes", function () {
	this.bail(true);

	modelBillingCreditNote.forEach(function (tc) {
		...
		it(tc.expected.case, function () {
			...
			assert.match(payloadRsp.id, /[cn_|cn_]_[a-zA-Z0-9]+/, 'Valid Credit Note Added');
		});
	});
...
//# sourceURL=stripe_billing_credit_notes_unit_tests.js
