 ...
 * @author ae
 */
public class MailBusinessRequestRejectedUx extends Mailer {
	 ...
	 *
	 */
	public MailBusinessRequestRejectedUx() {
		super();
	...
	public String generateHTML() {
		...
		b.append("<hr>");
		b.append("Apologies, " + recipientsName + " your counter business request has been rejected by, " + sendersName + "!<br>");
		b.append("<br>");
		b.append("<b><center>Business Request Detail</center></b>").append("<br>");
		b.append("Clients Name: " + sendersName + "<br>");
		b.append("Reason: " + reason + "<br>");
