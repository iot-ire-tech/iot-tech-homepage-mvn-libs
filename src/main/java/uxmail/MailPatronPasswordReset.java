 ...
 * @author ae
 */
public class MailPatronPasswordReset extends Mailer {
	...
	public static void main(String[] args) {
		...
		MailPatronPasswordReset m = new MailPatronPasswordReset();
...
// clientId=673859&patronId=787833
	 ...
	 *
	 */
	public MailPatronPasswordReset() {
		super();
	...
	public String generateHTML() {
		...
		String style = "padding:10px;"
			...
			+ "color:#ffffff;"
			+ "cursor:pointer;"
			+ "display:inline-block;font-size:14px;font-weight:bold;margin:0;text-decoration:none;text-transform:capitalize;";
		...
		b.append("<hr>");
		b.append("Hi, click on the button below to reset your password<br>");
		b.append("<br>");
		b.append("Client Id: " + getClientId()).append("<br>");
		b.append("Patron Id: " + getPatronId()).append("<br>");

		tmp = "href=" + getEndPointPasswordReset();
		b.append("<center><a style=" + style + " target='_blank'" + tmp + " >Reset</a></center>").append("<br>");
...
//		tmp = "href=" + getEndPointSupport() + clientId;
	...
	public String getEndPointPasswordReset() {
		return endPointPasswordReset;
	}

	public void setEndPointPasswordReset(String endPointPasswordReset) {
		this.endPointPasswordReset = endPointPasswordReset;
	}
