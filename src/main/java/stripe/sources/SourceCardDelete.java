...
/**
 */
@WebServlet(name = "DeleteSourceCard", urlPatterns = {"/DeleteSourceCard"})
public class SourceCardDelete extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		try {
			...
			Logger.getLogger(SourceCardDelete.class.getName()).log(Level.SEVERE, null, ex);
			return;
		}
