...
/**
 */
@WebServlet(name = "UpdateSourceCard", urlPatterns = {"/UpdateSourceCard"})
public class SourceCardUpdate extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		try {
			...
			Logger.getLogger(SourceCardUpdate.class.getName()).log(Level.SEVERE, null, ex);
			return;
		}
