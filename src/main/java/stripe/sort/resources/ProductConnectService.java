...
/**
 */
@WebServlet(name = "ProductConnectService", urlPatterns = {"/ProductConnectService"})
public class ProductConnectService extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		try {
			...
			System.out.println("INF: Processed Product Creation(connect) Starting");

			productParams.clear();
			productParams.put("name", "bookingBasicI");
...
// https://stripe.com/docs/api/products/create
			...
			System.out.println("INF: Processed Product Creation(connect) Completed");

		} catch (StripeException ex) {
			Logger.getLogger(ProductConnectService.class.getName()).log(Level.SEVERE, null, ex);
