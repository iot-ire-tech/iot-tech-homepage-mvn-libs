 ...
 *
 */
@WebServlet(name = "PaymentIntentCard", urlPatterns = {"/PaymentIntentCard"})
public class PaymentIntentCard extends HttpServlet {
	...
	UXPayloadPaymentIntent uxPayload;
	String responseLoad;
	...
	String accountIdPlatform = "";				// Test : Connect Account -
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		try {
			...
			uxPayload = gson.fromJson(sb.toString(), UXPayloadPaymentIntent.class);
...
// https://stripe.com/docs/api/customers/create
			...
			response.getOutputStream().print("{ "
				...
				+ "\"status\": \"failed\" "
				+ "}");
			Logger.getLogger(PaymentIntentCard.class.getName()).log(Level.SEVERE, null, ex);
		}
	...
	public void init() throws ServletException {
		...
		gson = new Gson();
		sb = new StringBuilder();
		uxPayload = new UXPayloadPaymentIntent();
...
has_more: false,
total_count: 0,
url: "/v1/charges?payment_intent=pi_1Eq2sLEUIbzLqhwX8d1QNxbV",
count: null,
request_options: null,
request_params: null,
},
client_secret: "pi_1Eq2sLEUIbzLqhwX8d1QNxbV_secret_aBWgxeywPYDd5SkaVMktXbaVd",
confirmation_method: "automatic",
created: 1561662197,
currency: "eur",
customer: null,
description: "Customer for jenny.rosen@example.com",
id: "pi_1Eq2sLEUIbzLqhwX8d1QNxbV",
invoice: null,
