...
/**
 */
@WebServlet(name = "AddTokenBankAch", urlPatterns = {"/AddTokenBankAch"})
public class TokenBankAch extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		tokenParams.put("account_holder_type", uxPayload.getAccountHolderType());	// Works
		// BIC
		tokenParams.put("routing_number", uxPayload.getRoutingNumber());
