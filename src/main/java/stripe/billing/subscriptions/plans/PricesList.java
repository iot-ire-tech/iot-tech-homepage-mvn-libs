...
/**
 */
@WebServlet(name = "PricesList", urlPatterns = {"/PricesList"})
public class PricesList extends HttpServlet {
...
//				entity = Price.list(params, auth);
			...
			Logger.getLogger(PricesList.class.getName()).log(Level.SEVERE, null, ex);
			return;
		}
