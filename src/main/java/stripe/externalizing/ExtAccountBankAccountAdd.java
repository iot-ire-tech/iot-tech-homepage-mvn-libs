 ...
 *
 */
@WebServlet(name = "ExtBankAccountAdd", urlPatterns = {"/ExtBankAccountAdd"})
public class ExtAccountBankAccountAdd extends HttpServlet {
...
// Builder
			...
			entityParams.put("external_account", uxPayload.getTokenId());
			...
			Logger.getLogger(ExtAccountBankAccountAdd.class.getName()).log(Level.SEVERE, null, ex);
			return;
		}
		System.out.println("INF: " + gson.toJson(uxPayload));
