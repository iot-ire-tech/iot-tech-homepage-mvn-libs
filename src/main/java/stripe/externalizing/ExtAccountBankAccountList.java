 ...
 *
 */
@WebServlet(name = "ExtBankAccountList", urlPatterns = {"/ExtBankAccountList"})
public class ExtAccountBankAccountList extends HttpServlet {
...
// Builder
			...
			entitys = entity.getExternalAccounts().getData();

		} catch (StripeException ex) {
			System.out.println("ERR: " + ex.getMessage());
			System.out.println("INF: " + gson.toJson(uxPayload));
			Logger.getLogger(ExtAccountBankAccountList.class.getName()).log(Level.SEVERE, null, ex);
			return;
		}
