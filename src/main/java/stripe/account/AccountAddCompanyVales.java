...
@WebServlet(name = "AccountAddCompanyValues", urlPatterns = {"/AccountAddCompanyValues"})
public class AccountAddCompanyVales extends HttpServlet {
...
//		account = Account.retrieve("acct_1FVKzaEorBpR5gzM").delete();
		...
		relationship.clear();
		if (!hasRep) {
			roleRepresentative.put("first_name", "Anto(Rep)");
			roleRepresentative.put("last_name", "Ennis.");
			roleRepresentative.put("email", "tonyennis@yahoo.com");
			roleRepresentative.put("phone", "(555) 678-1212");
			dob.put("year", 1972);
			dob.put("month", 12);
			dob.put("day", 1);
			...
			relationship.put("title", "Herr Rep");
...
//			roleRepresentative.put("verification", verf.addDocument("front", "back").addAdditional("front", "back").getVerification());
...
//			roleOwner.put("verification", verf.addDocument("front", "back").addAdditional("front", "back").getVerification());
...
//		company.put("verification", verf.addDocument("front", "back").getVerification());
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			Logger.getLogger(AccountAddCompanyVales.class.getName()).log(Level.SEVERE, null, ex);
		}
	}
