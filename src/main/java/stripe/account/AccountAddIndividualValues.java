...
@WebServlet(name = "AccountAddIndividualValues", urlPatterns = {"/AccountAddIndividualValues"})
public class AccountAddIndividualValues extends HttpServlet {
...
//		account = Account.retrieve("acct_1FVKygIS3cjqEIcW").delete();
//		account = Account.retrieve("acct_1FVKzaEorBpR5gzM").delete();
		...
		// Start Of Indiviual
		// Start Of Indiviual
		roleIndividual.put("first_name", "Anto");
		roleIndividual.put("last_name", "Ennis.");
		roleIndividual.put("email", "tonyennis@yahoo.com");
		roleIndividual.put("phone", "(555) 678-1212");
		dob.put("year", 1972);
		dob.put("month", 12);
		dob.put("day", 1);
		roleIndividual.put("dob", dob);
		address.put("city", "Dublin");
		address.put("country", "IE");
		address.put("line1", "48 tritonville road");
		address.put("postal_code", "40000");
		address.put("state", "D");
		roleIndividual.put("address", address);
		relationship.put("executive", true);
		relationship.put("owner", true);
		relationship.put("account_opener", true);
		relationship.put("director", true);
		relationship.put("title", "GEO");
		roleIndividual.put("relationship", relationship);

		account.persons().create(roleIndividual);

//		individual.put("verification", verf.addDocument("front", "back").addAdditional("front", "back").getVerification());
		...
		business_profile.put("name", "My Connect Account"); // Sector
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			Logger.getLogger(AccountAddIndividualValues.class.getName()).log(Level.SEVERE, null, ex);
		}
	}
