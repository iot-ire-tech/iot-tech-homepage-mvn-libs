 ...
 */
@WebServlet(name = "AccountUpdateAddress", urlPatterns = {"/AccountUpdateAddress"})
public class AccountUpdateAddress extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws IOException, StripeException {
		...
		uxPayload = gson.fromJson(sb.toString(), EntAddress.class);
...
// Persons Account :https://stripe.com/docs/api/persons/create
		...
		person.put("email", "tonyennis@yahoo.com");
...
// https://stripe.com/docs/api/accounts/create
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			Logger.getLogger(AccountUpdateAddress.class.getName()).log(Level.SEVERE, null, ex);
		}
	}
