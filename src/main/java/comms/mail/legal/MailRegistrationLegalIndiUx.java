 ...
 * @author ae
 */
public class MailRegistrationLegalIndiUx extends Mailer {
	...
	public MailRegistrationLegalIndiUx(String to, String from, String fromAlias, String subject, String msgbody) {
		super(to, from, fromAlias, subject, msgbody);
	}

	public MailRegistrationLegalIndiUx(String to, String from, String fromAlias, String subject) {
	 ...
	 *
	 */
	public MailRegistrationLegalIndiUx() {
		super();
	...
	public String generateHTML() {
		...
		b.append("<br>");
		b.append("<hr>");
		b.append("<b><center>Automated Legal Confirmation Detail</center></b>");
		b.append("<hr>");
//		b.append("Congratulations, " + getSource().getPerson().getFirstName() + " you have added a banking payment point to your platform.");
		b.append("Soon you will be able to receive payments from customers to this account!");
...
//		b.append("IBAN: " + getSource().getAccountNumber()).append("<br>");
		...
		b.append("<b><center>Enable Payments On You Account (System Admins)</center></b>").append("<br>");
		b.append("If not already so, you could add a card payments-in method too, reassuring your payments-in capability").append("<br>");
	...
	public EntAccount getSource() {
		return source;
	}

	public void setSource(EntAccount source) {
		this.source = source;
	}
