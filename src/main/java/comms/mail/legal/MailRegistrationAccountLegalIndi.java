 ...
 * @author ae
 */
@WebServlet(name = "MailerRegistrationLegalIndi", urlPatterns = {"/MailerRegistrationLegalIndi"})
public class MailRegistrationAccountLegalIndi extends HttpServlet {
	...
	StringBuilder sb;
	MailRegistrationLegalIndiUx mailer;
...
//		uxPayload = gson.fromJson(sb.toString(), EntMailLegalIndi.class);
...
//  Build Endpoints
		...
		//
		//
		mailer.setTo(uxPayload.getIndividual().getEmail());
		mailer.init();

		response.getOutputStream().print(gson.toJson(mailer));
	...
	public void init() throws ServletException {
		...
		// Base Classs
		mailer = new MailRegistrationLegalIndiUx();
		...
		gson = new Gson();
		sb = new StringBuilder();
//		uxPayload = new EntMailLegalIndi();
