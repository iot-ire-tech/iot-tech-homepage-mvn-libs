 ...
 * @author ae
 */
public class MailCustomerPaymentsCardsUx extends Mailer {
	...
	public MailCustomerPaymentsCardsUx(String to, String from, String fromAlias, String subject, String msgbody) {
		super(to, from, fromAlias, subject, msgbody);
	}

	public MailCustomerPaymentsCardsUx(String to, String from, String fromAlias, String subject) {
	 ...
	 *
	 */
	public MailCustomerPaymentsCardsUx() {
		super();
	...
	public String generateHTML() {
		...
		b.append("Soon you will be able to pay for services and goods offered by your platform by card!");
...
//		b.append("Day: " + getSource().getDay()).append("<br>");
		...
		b.append("CustomerId: " + getSource().getCustomerId()).append("<br>");

		// Update Card Details Link
//		b.append("<b><center>Enable Payments On You Account </center></b>").append("<br>");
//		b.append("If not already so, you could add a bank payments too").append("<br>");
