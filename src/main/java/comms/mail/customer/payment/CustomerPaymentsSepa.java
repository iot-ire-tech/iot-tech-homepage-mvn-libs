 ...
 * @author ae
 */
@WebServlet(name = "MailerCustomerPaymentsSepa", urlPatterns = {"/MailerCustomerPaymentsSepa"})
public class CustomerPaymentsSepa extends HttpServlet {
...
//  Build Endpoints
		...
		mailer.setEndPointPaymentsCARD(hostnameEndUser + pr.setKey("endPointPaymentsCardCustomer").getVal()
			+ "?accountId=" + uxPayload.getAccountId()
			+ "&customerId=" + uxPayload.getCustomerId()
		);
