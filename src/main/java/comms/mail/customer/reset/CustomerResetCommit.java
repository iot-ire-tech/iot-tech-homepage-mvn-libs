 ...
 * @author ae
 */
@WebServlet(name = "CustomerPasswordReset", urlPatterns = {"/CustomerPasswordReset"})
public class CustomerResetCommit extends HttpServlet {
...
//  Build Endpoints
    ...
    public void init() throws ServletException {
        ...
        // Base Classs
        mailer = new CustomerResetCommitUx();
        mailer.setSubject("INF: MyBusinessPal.Com - Account Request Confirmation");
        mailer.setFrom("security@mybusinesspal.com");
        mailer.setFromAlias("MyBusinessPal.Com Security Update");

        // Derived Class
        mailer.setTitle("MyBusinessPal.Com - Account Request Confirmation");
        gson = new Gson();
        sb = new StringBuilder();
