...
import comms.mail.alerts.EntMailBusinessInventoryAlert;
import servlet.Mailer;

/**
 * @author ae
 */
public class MailPnPNewOrderUx extends Mailer {
    ...
    String title;
    String ts;
    EntPnpMailPayload source;

    public static void main(String[] args) {

    }

    public MailPnPNewOrderUx(String to, String from, String fromAlias, String subject, String msgbody) {
        super(to, from, fromAlias, subject, msgbody);
    }

    public MailPnPNewOrderUx(String to, String from, String fromAlias, String subject) {
    ...
    public String generateHTML() {
        ...
        b.append("<hr>");
        b.append("A new order has been placed by a customer. Please take action to resolve.");
        b.append("<br>");

        b.append("<b><center>Shipping Details</center></b>").append("<br>");

        b.append("<br>");
        b.append("Account Id: " + getSource().getAccountId()).append("<br>");
        b.append("Customer Id: " + getSource().getCustomerId()).append("<br>");
        b.append("Product Id: " + getSource().getProductId()).append("<br>");
        b.append("<br><br>");
        b.append("Shipping Mode: " + getSource().getGrade()).append("<br>");
        b.append("Incoming Date: " + getSource().getTs()).append("<br>");
        b.append("Product Name: " + getSource().getProductName()).append("<br>");
    ...
    public EntPnpMailPayload getSource() {
        return source;
    }

    public void setSource(EntPnpMailPayload source) {
        this.source = source;
    }
}
