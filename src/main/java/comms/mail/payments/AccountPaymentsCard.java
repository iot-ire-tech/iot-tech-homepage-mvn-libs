...
import comms.mail.customer.payment.MailCustomerPaymentsCardsUx;
 ...
 * @author ae
 */
@WebServlet(name = "MailerRegistrationPaymentsCard", urlPatterns = {"/MailerRegistrationPaymentsCard"})
public class AccountPaymentsCard extends HttpServlet {
...
//  Build Endpoints
		...
		mailer.setEndPointPaymentsSEPA(hostnameEndUser + pr.setKey("endPointPaymentsSepa").getVal() + "?accountId=" + uxPayload.getAccountId());
