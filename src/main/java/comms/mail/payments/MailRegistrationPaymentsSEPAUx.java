 ...
 * @author ae
 */
public class MailRegistrationPaymentsSEPAUx extends Mailer {
	...
	public MailRegistrationPaymentsSEPAUx(String to, String from, String fromAlias, String subject, String msgbody) {
		super(to, from, fromAlias, subject, msgbody);
	}

	public MailRegistrationPaymentsSEPAUx(String to, String from, String fromAlias, String subject) {
	 ...
	 *
	 */
	public MailRegistrationPaymentsSEPAUx() {
		super();
	...
	public String generateHTML() {
		...
		b.append("Soon you will be able to recieve payments from customers to this account!");
		...
		if ("IE" != "IE") {
			b.append("<b><center>Enable Card Payments On Your Account (System Admins)</center></b>").append("<br>");
