 ...
 * @author ae
 */
@WebServlet(name = "ZommWebinarGet", urlPatterns = {"/ZommWebinarGet"})
public class ZoomWebinarGet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		// 	code: 3038
		//	message: "This webinar is over, you can no longer register for this webinar. If you have any questions, please contact the webinar host."
		//
		// "Webinar host can not register for the webinar."
		try {

			String jwt = myservice.getJWT("");
			responsex = Unirest.get("https://api.zoom.us/v2/webinars/" + uxPayload.getWebinarId())
