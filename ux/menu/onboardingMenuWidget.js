function UxOnboardingMenuWidget() {
    this.html = ""
    this.init = function () {
        ...
        this.html += "<a href='#' class='w3-bar-item w3-button w3-light-gray onboardingHome' style='width:20%'><i class='fa fa-sign-out'></i>Logout</a>"
        this.html += ""
        this.html += "</div>"
        return this.html;
    }
