...
describe("Creating Individual Connect Account", function () {
	this.bail(true);

	modelAccountAddIndividual.forEach(function (tc) {
		...
		it(tc.expected.case, function () {
			...
			assert.match(payloadRsp.id, /[acct_|acct_]_[a-zA-Z0-9]+/, 'Valid Individual Account Added');
...
//# sourceURL=stripe_connect_indivual_unit_tests.js
