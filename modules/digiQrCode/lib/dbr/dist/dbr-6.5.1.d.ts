    ...
    namespace BarcodeReader{
        ...
        */
        class Scanner{
            ...
            intervalTime: number;
            /**
             * <p>Defines the different settings of the barcode reader itself. Find a full list of these settings and their corresponding descriptions [here](https://www.dynamsoft.com/help/Barcode-Reader/devguide/Template/TemplateSettingsList.html).</p>
             * <p>The default setting is for an environment with accurate focus and good lighting. The settings below are for more complex environments.</p>
             * ```js
